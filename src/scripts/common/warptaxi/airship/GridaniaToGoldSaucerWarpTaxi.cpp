...
class GridaniaToGoldSaucerWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  constexpr static auto InnTerritoryType = 179;

  GridaniaToGoldSaucerWarpTaxi() :
    Sapphire::ScriptAPI::EventScript( 131181 )
  {
  }
...
EXPOSE_SCRIPT( GridaniaToGoldSaucerWarpTaxi );