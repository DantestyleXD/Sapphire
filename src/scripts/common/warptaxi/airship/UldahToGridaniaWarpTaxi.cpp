...
class UldahToGridaniaWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  UldahToGridaniaWarpTaxi() :
    Sapphire::ScriptAPI::EventScript( 0x0002001D )
  {
  }
...
EXPOSE_SCRIPT( UldahToGridaniaWarpTaxi );