...
class UldahToLimsaWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  UldahToLimsaWarpTaxi() :
    Sapphire::ScriptAPI::EventScript( 0x0002001E )
  {
  }
...
EXPOSE_SCRIPT( UldahToLimsaWarpTaxi );