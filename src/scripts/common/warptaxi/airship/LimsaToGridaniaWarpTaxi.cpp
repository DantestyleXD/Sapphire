...
class LimsaToGridaniaWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  LimsaToGridaniaWarpTaxi() :
    Sapphire::ScriptAPI::EventScript( 0x00020022 )
  {
  }
...
EXPOSE_SCRIPT( LimsaToGridaniaWarpTaxi );