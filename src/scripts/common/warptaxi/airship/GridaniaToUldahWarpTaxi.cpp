...
class GridaniaToUldahWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  GridaniaToUldahWarpTaxi() :
    Sapphire::ScriptAPI::EventScript( 0x0002001F )
  {
  }
...
EXPOSE_SCRIPT( GridaniaToUldahWarpTaxi );