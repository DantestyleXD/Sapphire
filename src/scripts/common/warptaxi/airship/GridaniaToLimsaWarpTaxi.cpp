...
class GridaniaToLimsaWarpTaxi : public Sapphire::ScriptAPI::EventScript
{
public:
  GridaniaToLimsaWarpTaxi() : Sapphire::ScriptAPI::EventScript( 0x00020020 )
  {
  }
...
EXPOSE_SCRIPT( GridaniaToLimsaWarpTaxi );