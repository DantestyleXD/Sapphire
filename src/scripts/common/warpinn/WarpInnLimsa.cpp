...
public:
  ...
  WarpInnLimsa() :
    Sapphire::ScriptAPI::EventScript( 131104 )
  {
  }
   ...
   auto& exdData = Common::Service< Sapphire::Data::ExdData >::ref();
    ...
    auto qualifiedPreResult = [ this ]( Entity::Player& player, const Event::SceneResult& result )
    {
      if( result.getResult( 0 ) == 1 )
      {
        ...
        eventMgr().playScene( player, result.eventId, 0, HIDE_HOTBAR, { 1 }, warpChoice );
      }
    };
    ...
    if( player.hasReward( Common::UnlockEntry::InnRoom ) )
      ...
      eventMgr().playScene( player, eventId, 1, HIDE_HOTBAR, { 1 }, nullptr );
  }
};
